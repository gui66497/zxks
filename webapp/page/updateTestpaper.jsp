...
<head>
    ...
    <script type="application/javascript" src="../js/testPaper/updateTestpaper.js"></script>
    ...
    <style type="text/css">
        ...
        th,td,button,span,div,select,textarea[placeholder]{
        ...
        <div class="container" style="width: 80%">
            <div style="margin-top:9px;position:relative">
                <ul class="breadcrumb" style="font-family:微软雅黑;font-size: 15px">
                    ...
                    <li class="active" id="actionLi" style="font-size: 14px">修改试卷</li>
                </ul>
            ...
            <div class="row">
                <div class="span3" id="myScrollspy" style="width: 20%">
                    ...
                    <ul id="myAffix" class="nav nav-pills nav-stacked" style="text-align:center;">
                        ...
                        <%--<li onclick="getSection('3')" name="myAffixLi" id="myAffixLi3"><a href="javascript:void(0)" name="totu">第四部分</a></li>--%>
                        ...
                        <div style="margin:20px 0;">
                            <a href="#" style="text-decoration:none;">
                                <button type="button" class="btn btn-warning btn-block" id="savePaperBtn" onclick="toUpdatePaper()" style="border: 0;">保存试卷</button>
                            </a>
                        </div>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="span11 right_details" name="partPaper" id="section-b">
                            <form class="form-horizontal" style="width:95%;margin:0 auto;padding-top:15px;">
                                ...
                                <div class="control-group">
                                    <select name="testPaperCategorySelect" id="testPaperCategorySelect" style="width: 400px" class="form-control" placeholder="请选择分类">
                                    </select>
                                </div>

                                <div class="control-group">
                                    <textarea class="dash_input" style="width: 95%;max-width: 95%" rows="2" id="testpaperDescription" placeholder="试卷描述，该信息考生不可见(必填)"  maxlength="200"></textarea>
                                </div>
                                <div class="control-group">
                    ...
                    <div class="row">
                        ...
                        <div class="span11 right_details" style="margin-top:20px;" id="section-0" name="partPaper">
                            <form class="form-horizontal" style="width:95%;margin:0 auto;padding-top:15px;">
                                ...
                                <div class="control-group">
                                    <div class="row">
                                        <label class="span1" style="white-space: nowrap;font-size:16px;color:#777;padding: 5px 0 0 6px;">第一部分</label>

                                        <div class="span3" style="width: 200px">
                                            <select name="testpaperModeSelect" style="width: 150px" class="form-control" placeholder="请选择分类">
                                        ...
                                        <div class="span1" style="padding-right:20px">
                                            <button type="button" name="selectItemBtn" class="btn btn-success" style="width: 100px;border: 0;">
                                                <span class="icon-plus icon-white" style="margin-top: 2px"></span>&nbsp智能添加</button>
                                        </div>
                                        <div class="span1" style="padding-right:20px">
                                            <button type="button" name="itemPersonalBtn" class="btn btn-success " style="width: 100px;border: 0;margin-left: 4px">
                                                <span class="icon-plus icon-white" style="margin-top: 2px"></span>&nbsp手工添加</button>
                                        </div>
                                        <div class="span1" style="margin-left:28px">
                                            <button type="button" class="btn btn-danger" name="delPartBtn" style="width: 120px;border: 0;display: none">
                                ...
                                <div class="control-group">
                                    <div class="row">
                                        <textarea id="partExplain0" name="partExplainArea" style="width: 95%;margin-left: 2%;max-width: 95%" class="form-control span11 dash_input" rows="2" placeholder="部分答题说明，该信息考生可见(选填)" maxlength="400"></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <blockquote style="border-left:5px solid #337AB7;display:inline;">题目详情</blockquote>
                                    ...
                                    <div class="btn-group" style="margin-left:0px;">
                                        <button type="button" name="continueAdd" >
                                            <span class="icon-plus icon-white" style="margin-top: 2px"></span>继续智能添加
                                        </button>
                                    </div>
                                    <div class="btn-group" style="margin-left:0px;">
                                        <button type="button" name="continuePersonalAdd">
                                ...
                                <div class="control-group">
                                    <div class="table-responsive">
                                        <table id="tb0" class="table table-striped table-bordered table-hover">
                                            <thead>
                                            <tr>
                    ...
                    <div class="row">
                        ...
                        <div class="span11 right_details" style="margin-top:20px;" id="section-1" name="partPaper">
                            <form class="form-horizontal" style="width:95%;margin:0 auto;padding-top:15px;">
                                ...
                                <div class="control-group">
                                    <div class="row">
                                        <label class="span1" style="white-space: nowrap;font-size:16px;color:#777;padding: 5px 0 0 6px;">第二部分</label>
                                ...
                                <div class="control-group">
                                    <div class="row">
                                        <textarea id="partExplain1" name="partExplainArea" style="width: 95%;margin-left: 2%;max-width: 95%" class="form-control span11 dash_input" rows="2" placeholder="部分答题说明，该信息考生可见(选填)" maxlength="400"></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <blockquote style="border-left:5px solid #337AB7;display:inline;">题目详情</blockquote>
                                    ...
                                    <div class="btn-group" style="margin-left:0px;">
                                        <button type="button" name="continueAdd" class="btn btn-default btn-md hide" >
                                            <span class="icon-plus icon-white" style="margin-top: 2px"></span>&nbsp继续智能添加
                                        </button>
                                    </div>
                                    <div class="btn-group" style="margin-left:0px;">
                                        <button type="button" name="continuePersonalAdd" class="btn btn-default btn-md hide">
                    ...
                    <div class="row">
                        ...
                        <div class="span11 right_details" style="margin-top:20px;" id="section-2" name="partPaper">
                            <form class="form-horizontal" style="width:95%;margin:0 auto;padding-top:15px;">
                                ...
                                <div class="control-group">
                                    <div class="row">
                                        <label class="span1" style="white-space: nowrap;font-size:16px;color:#777;padding: 5px 0 0 6px;">第三部分</label>
                                        <div class="span3"style="width: 200px">
                                            <select name="testpaperModeSelect" style="width: 150px;" class="form-control" placeholder="请选择分类">
                                                <option VALUE=1>单选题</option>
                                                <option VALUE=2>多选题</option>
                                ...
                                <div class="control-group">
                                    <div class="row">
                                        <textarea id="partExplain2" name="partExplainArea" style="width: 95%;margin-left: 2%;max-width: 95%" class="form-control span11 dash_input" rows="2" placeholder="部分答题说明，该信息考生可见(选填)" maxlength="400"></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <blockquote style="border-left:5px solid #337AB7;display:inline;">题目详情</blockquote>
                                ...
                                <div class="control-group">
                                    <div class="table-responsive">
                                        <table id="tb2" class="table table-striped table-bordered table-hover">
                                            <thead>
                                            <tr>
...
<span id="dataIndexSpan" style="display: none"></span>
</body>
</html>